...
int main(int argc, char *argv[]) {
  try {
    ...
    RandomAccessBaseFloatVectorReader weights_reader(weights_rspecifier);//std::cout<<"weights_rspecifier "<<weights_rspecifier<<std::endl;
    ...
    if (ClassifyWspecifier(wspecifier_or_wxfilename, NULL, NULL, NULL)
      ...
      //std::cout<<"rspecifier "<<rspecifier<<std::endl;
      //std::cout<<"wspecifier "<<wspecifier<<std::endl;
      //std::cout<<"spk2utt_rspecifier "<<spk2utt_rspecifier<<std::endl;
      ...
      if (spk2utt_rspecifier != "") {
        ...
        for (; !spk2utt_reader.Done(); spk2utt_reader.Next()) {
          ...
          for (size_t i = 0; i < uttlist.size(); i++) {
            std::string utt = uttlist[i]; //std::cout<<"uttlist["<<i<<"]: "<<utt<<std::endl;
